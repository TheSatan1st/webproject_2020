...
<div class="banner shadow banner_main">
			<div class="banner_text">
				...
				<a href="/services/" class="secondary_button_l"><?php  echo get_field('button2'); ?></a>
			</div>
    ...
    <div class="container">
		...
		<?php get_template_part('template-parts/cases_block');?>
			...
			<a href="/ru/agency/cases-ru//" class="secondary_button_s getCases"><?php  echo get_field('button3'); ?></a>
		</div>
